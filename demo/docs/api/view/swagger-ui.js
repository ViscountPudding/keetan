...
(function() {
  var ContentTypeView, HeaderView, MainView, OperationView, ParameterContentTypeView, ParameterView, ResourceView, ResponseContentTypeView, SignatureView, StatusCodeView, Ui, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  Ui = (function(_super) {
    ...
    Ui.prototype.dom_id = "swagger_ui";

    Ui.prototype.options = null;

    Ui.prototype.api = null;

    Ui.prototype.headerView = null;

    Ui.prototype.mainView = null;
    ...
    Ui.prototype.render = function() {
      var _this = this;
      this.showMessage('Finished Loading Resource Information. Rendering  UI...');
    ...
    Ui.prototype.buildUrl = function(base, url) {
      var parts;
    ...
    Ui.prototype.showMessage = function(data) {
      if (data == null) {
        data = '';
      }
    ...
    Ui.prototype.onLoadFailure = function(data) {
      var val;
      if (data == null) {
        data = '';
      }
