...
(function() {
  var ApiKeyAuthorization, PasswordAuthorization, Api, Authorizations, Http, Model, ModelProperty, Operation, Request, Resource,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  Api = (function() {
    Api.prototype.url = "http://api.wordnik.com/v4/resources.json";

    Api.prototype.debug = false;

    Api.prototype.basePath = null;

    Api.prototype.authorizations = null;

    Api.prototype.authorizationScheme = null;

    Api.prototype.info = null;
    ...
    Api.prototype.build = function() {
      ...
      new Http().execute(obj);
      return this;
    };

    Api.prototype.buildFromSpec = function(response) {
      ...
      if (isApi) {
        ...
        res = new Resource(response, this);
        ...
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          resource = _ref2[_k];
          res = new Resource(resource, this);
    ...
    Api.prototype.buildFrom1_1Spec = function(response) {
      var api, isApi, newName, operation, res, resource, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
      console.log("This API is using a deprecated version of !  Please see http://github.com/wordnik/swagger-core/wiki for more info");
      if (response.apiVersion != null) {
        this.apiVersion = response.apiVersion;
      }
      this.apis = {};
    ...
    Api.prototype.fail = function(message) {
      this.failure(message);
      throw message;
    };

    Api.prototype.setConsolidatedModels = function() {
  ...
  Resource = (function() {
    ...
    Resource.prototype.produces = null;

    Resource.prototype.consumes = null;

    function Resource(resourceObj, api) {
      ...
      if ((resourceObj.apis != null) && (this.api.resourcePath != null)) {
        ...
        if (this.path == null) {
          this.api.fail("Resources must have a path.");
        }
    ...
    Resource.prototype.addApiDeclaration = function(response) {
    ...
    Resource.prototype.addModels = function(models) {
      var model, modelName, swaggerModel, _i, _len, _ref, _results;
      if (models != null) {
        for (modelName in models) {
          if (this.models[modelName] == null) {
            swaggerModel = new Model(modelName, models[modelName]);
    ...
    Resource.prototype.addOperations = function(resource_path, ops, consumes, produces) {
      ...
      if (ops) {
        ...
        for (_i = 0, _len = ops.length; _i < _len; _i++) {
          ...
          op = new Operation(o.nickname, resource_path, method, o.parameters, o.summary, o.notes, type, responseMessages, this, consumes, produces);
    ...
    Resource.prototype.sanitize = function(nickname) {
      var op;
    ...
    Resource.prototype.help = function() {
  ...
  Model = (function() {
    function Model(modelName, obj) {
      ...
      for (propertyName in obj.properties) {
        ...
        prop = new ModelProperty(propertyName, obj.properties[propertyName]);
        this.properties.push(prop);
      }
    }

    Model.prototype.setReferencedModels = function(allModels) {
  ...
  ModelProperty = (function() {
    function ModelProperty(name, obj) {
      this.name = name;
    ...
    ModelProperty.prototype.getSampleValue = function(modelsToIgnore) {
      var result;
  ...
  Operation = (function() {
    function Operation(nickname, path, method, parameters, summary, notes, type, responseMessages, resource, consumes, produces) {
      ...
      if (this.nickname == null) {
        this.resource.api.fail("Operations must have a nickname.");
      }
      if (this.path == null) {
        this.resource.api.fail("Operation " + nickname + " is missing path.");
      }
      if (this.method == null) {
        this.resource.api.fail("Operation " + nickname + " is missing method.");
      }
    ...
    Operation.prototype.isListType = function(type) {
      if (type.indexOf('[') >= 0) {
    ...
    Operation.prototype["do"] = function(args, opts, callback, error) {
      ...
      req = new Request(this.method, this.urlify(args), params, opts, callback, error, this);
      if (opts.mock != null) {
        return req;
      } else {
        return true;
    ...
    Operation.prototype.pathJson = function() {
      return this.path.replace("{format}", "json");
    };

    Operation.prototype.pathXml = function() {
    ...
    Operation.prototype.getQueryParams = function(args) {
    ...
    Operation.prototype.getMatchingParams = function(paramTypes, args) {
  ...
  Request = (function() {
    function Request(type, url, params, opts, successCallback, errorCallback, operation, execution) {
      ...
      if (this.successCallback == null) {
        throw "Request successCallback is required.";
      }
      if (this.errorCallback == null) {
        throw "Request error callback is required.";
      }
      if (this.operation == null) {
        throw "Request operation is required.";
      }
  ...
  Http = (function() {
    Http.prototype.Shred = null;

    Http.prototype.shred = null;

    Http.prototype.content = null;
    ...
    Http.prototype.execute = function(obj) {
  ...
  Authorizations = (function() {
    Authorizations.prototype.authz = null;

    function Authorizations() {
      this.authz = {};
    }

    Authorizations.prototype.add = function(name, auth) {
      this.authz[name] = auth;
      return auth;
    };

    Authorizations.prototype.apply = function(obj) {
